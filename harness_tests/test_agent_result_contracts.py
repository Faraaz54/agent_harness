...
def test_implementation_result_contract_accepts_structured_output(tmp_path):
    ...
    try:
        write(path, {
            ...
            "context_files_used": [{"context_id": "CTX-GENERIC-README", "path": "project-packs/generic-python/context/README.md", "used_for": ["implementation"]}],
...
def test_domain_review_result_contract_accepts_structured_findings(tmp_path):
    ...
    try:
        write(path, {
            ...
            "context_files_reviewed": [{"context_id": "CTX-GENERIC-README", "path": "project-packs/generic-python/context/README.md", "used_for": ["domain_review"]}],
